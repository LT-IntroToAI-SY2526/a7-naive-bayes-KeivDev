...
if __name__ == "__main__":
    ...
    print(b.classify("This book is based on rigorous, meticulous reportage, and is written in a style that makes the looming black box of AI comprehensible to the non-expert, which is a feat in itself. To me the most ingenious and revelatory--really, breathtaking--insight in the book is Hao's conceptualization of AI as not so much an entirely new thing under the sun but as a corporate pursuit that reprises empire and colonial, imperial systems of the nineteenth century, and earlier. It's a brilliant point, keenly developed to the point that it stirred my outrage against the system. In other words, Hao is using "EMPIRE" in a very literal, not metaphorical or figurative sense. The AI giants extract resources and steal when they can to advance their competitive ends. As we have seen before, idealistic notions defer to profit, eventually.My only reason for giving this four stars instead of five is the length, and the reading experience that follows. The book in my estimation might have been a solid 150 to 200 pages shorter, and trimmed of some of the insider detail and corporate machinations, which are fine for shorter WSJ articles but tended to bog down the book. I think this would have been a truly galvanizing work had it been edited for length and detail....However! I would still highly recommend this, and Hao's tremendous work to introduce AI to the neophytes and non-tech people such as myself who are concerned yet largely oblivious. It's a wonderful accomplishment. "))
    print(b.classify("I ordered inside and ended up waiting with a couple other people for over 40 minutes for my breakfast food. When I received it, my coffee iced coffee was half melted, the hash brown was cold and soggy, the sausage egg McMuffin was fresh. There were at least 10 people waiting for their food when I walked in at 10:15 AM. I ordered my food at 10:20 AM and didn’t receive my food until 10:51pm. I asked to speak to the manager, and I was told one second as the lady turned around and started doing something else . I spoke to the“manager”, a different lady who said she was the manager. I told her it was ridiculous to wait this long for food and I would like my money back. So she went to go talk to someone else the first ”manager” I spoke with who pretended not to be the manager. At this time, I have recorded a video and took pictures of the whole congested scene and lack of management. I asked the manager for my money back and I wanted to keep my food, she went to go talk to someone and never came back. I had a doctors appointment and I had stopped into this restaurant yesterday for something to drink and stood in line for 15 minutes then eventually walked out because their service was so slow. I tried to order on the do it yourself screen and their printer was out of paper so I couldn’t give her my order ticket. Overall, their service is horrible. The management is laughable and needs to be fixed. Myself and others shouldn’t have to wait 40+ minutes for a sausage McMuffin with egg and a medium iced coffee. I also should’ve been compensated for my time."))
    print(b.classify("Ah I tried to get a Room there after my wife abandoned me, but was denied because of my Credit. The Employee at the front desk was nice to Me and very helpful but the person who denied me because of my Credit was Heartless..i am rebuilding myself after losing everything I had and the person who denied me the opportunity to get a fresh start is Brutal."))
